...
function ChainIcon({ chain }: { chain: ChainKey }) {
  if (chain === 'ethereum') {
    return <img className="chain-icon eth" src={assetUrl('brand/eth.svg')} alt="" />
  }
      ...
      <header className="topbar">
        ...
        <div className="brand-block">
          <button type="button" className="brand" onClick={() => go('overview')}>
            <img className="brand-logo" src={assetUrl('brand/HEXagon.svg')} alt="" />
          ...
          <section className="view mining-view">
            <div className="tab-bar" role="tablist" aria-label="Network">
              {(
                ...
                >
                  {id === 'ethereum' ? (
                    <img className="chain-icon eth" src={assetUrl('brand/eth.svg')} alt="" />
                  ) : null}
                  {id === 'pulsechain' ? (
